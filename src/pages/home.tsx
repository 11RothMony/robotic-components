...
import { ComponentData, ComponentProps, Lesson } from "@/types";
...
export default function HomePage() {
  ...
  const [selectedLesson, setSelectedLesson] = useState<ComponentData[]>([]);
      ...
      <main className="w-full mx-auto">
        ...
        >
          {filteredLessons.map((lesson: Lesson) => (
            ...
            >
              <Image
                width={viewMode === "list" ? 48 : 120}
                height={viewMode === "list" ? 48 : 120}
        ...
        <Dialog
          open={selectedLesson.length !== 0}
          onOpenChange={() => setSelectedLesson([])}
        >
